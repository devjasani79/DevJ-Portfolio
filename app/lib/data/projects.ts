...
export const projects: Project[] = [
  {
    ...
    description:
      "Secure cloud storage with integrated AI that reads, analyzes, and answers questions about uploaded files — PDFs, images, documents. Per-user ACL isolation, real-time storage tracking, Groq-powered vision models.",
